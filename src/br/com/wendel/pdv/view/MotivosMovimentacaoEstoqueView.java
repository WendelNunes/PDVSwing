...
import br.com.wendel.pdv.controller.MotivosMovimentacaoEstoqueController;
 ...
 * @author INLOC
 */
public class MotivosMovimentacaoEstoqueView extends javax.swing.JPanel {

    private final MotivosMovimentacaoEstoqueController motivosMovimentacaoEstoqueViewController;
    private final MotivoMovimentacaoEstoqueTableModel motivoMovimentacaoEstoqueTableModel;
    private final JTableCustom<Map<String, Object>> tabela;

    /**
     * Creates new form MotivosMovimentacaoEstoqueView
     */
    public MotivosMovimentacaoEstoqueView() {
        this.motivosMovimentacaoEstoqueViewController = new MotivosMovimentacaoEstoqueController();
        this.motivoMovimentacaoEstoqueTableModel = new MotivoMovimentacaoEstoqueTableModel();
        this.tabela = new JTableCustom<>(this.motivoMovimentacaoEstoqueTableModel);
        initComponents();
    }
    ...
    public void atualizaTabela() throws Exception {
        this.motivosMovimentacaoEstoqueViewController.atualizaLista();
        this.motivoMovimentacaoEstoqueTableModel.setLista(this.motivosMovimentacaoEstoqueViewController.getList());
    }
    ...
    private void initComponents() {
        ...
        jLTitulo.setText("Motivos de Movimentação do Estoque");
