...
public class CidadeCadastroView extends javax.swing.JPanel {
     ...
     */
    public CidadeCadastroView(Long id) throws Exception {
        this.controller = new CidadeCadastroController(id);
        initComponents();
        this.jCBEstado.addItem(null);
        for (Estado value : Estado.values()) {
            this.jCBEstado.addItem(value);
        }
        if (this.controller.getCidade() != null) {
            this.jTFDescricao.setText(this.controller.getCidade().getDescricao());
            this.jCBEstado.setSelectedItem(this.controller.getCidade().getEstado());
        }
    ...
    private void initComponents() {
        ...
        jLDescricaoObrigatoria1 = new javax.swing.JLabel();
        jCBEstado = new javax.swing.JComboBox<Estado>();

        setBackground(new java.awt.Color(255, 255, 255));
        setFocusTraversalPolicy(new TraversalPolicy(asList(this.jTFDescricao, this.jCBEstado, this.jPButtonSalvar, this.jPButtonCancelar)));
        ...
        jTFDescricao.setToolTipText("Descrição da cidade");
        ...
        jLEstado.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLEstado.setText("Estado");

        jLDescricaoObrigatoria1.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jLDescricaoObrigatoria1.setForeground(new java.awt.Color(255, 0, 0));
        jLDescricaoObrigatoria1.setText("*");

        jCBEstado.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        jCBEstado.setToolTipText("Estado da cidade");
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jPTopo, javax.swing.GroupLayout.DEFAULT_SIZE, 442, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(0, 0, 0)
                                .addComponent(jLDescricaoObrigatoria1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLEstado)
                    .addComponent(jLDescricaoObrigatoria1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTFDescricaoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTFDescricaoKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            SwingUtilities.invokeLater(() -> {
                this.jCBEstado.requestFocusInWindow();
            });
        }
    ...
    private javax.swing.JLabel jLDescricaoObrigatoria1;
